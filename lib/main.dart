...
class MyHome extends StatelessWidget {
  final List<String> items = new List<String>.generate(5, (i) => "Items ${i+1}");


  @override
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: AppBar(title: Text("swipe to dismiss, search here"),
      actions: <Widget>[
...
//import 'package:flutter_try/todo_list.dart';
//import 'package:flutter_try/assignment.dart';
import 'package:flutter_try/todo_list.dart';
